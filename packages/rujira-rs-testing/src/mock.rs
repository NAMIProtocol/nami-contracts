...
use cosmwasm_std::{
    ...
    Addr, AnyMsg, Api, BankMsg, Binary, BlockInfo, CosmosMsg, CustomMsg, CustomQuery,
...
use cw_multi_test::{
    ...
    GovFailingModule, IbcFailingModule, Stargate, SudoMsg, WasmKeeper,
};
...
mod tests {
    ...
    fn query_pool() {
        ...
        assert_eq!(res.loan_cr, Decimal::zero());
